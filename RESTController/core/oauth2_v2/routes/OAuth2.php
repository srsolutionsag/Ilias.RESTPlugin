    ...
    $app->group('/oauth2', function () use ($app) {
        ...
        $app->post('/token', function () use ($app) {
            try {
                ...
                $apiSecret = $request->getParameter('api_secret', $request->getParameter('client_secret'));
                $remoteIp = $request->getClientIp();
                $apiCert = Libs\RESTLib::FetchClientCertificate();
                $iliasClient = Libs\RESTilias::FetchILIASClient();
                ...
                if ($grantType == 'refresh_token') {
                    ...
                    $apiKey = $request->getParameter('api_key', $request->getParameter('client_id'));
                    $scope = $request->getParameter('scope');
                ...
                // Manage all of the other supported grant-types...
                    ...
                    $apiKey = $request->getParameter('api_key') === null ? $request->getParameter('client_id', null, true) : $request->getParameter('api_key', null, true);
